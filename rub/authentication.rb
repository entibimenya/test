API_KEY = '77naykdvirz5qn' #Your app's API key
  API_SECRET = 'MmEXLcxGNz6bYt4Y' #Your app's API secret
  REDIRECT_URI = 'http://www.http://linkemap.bl.ee/aftersignpage.html' #Redirect users after authentication to this path, ensure that you have set up your routes to handle the callbacks
  STATE = SecureRandom.hex(AnDeRsOnCaHeTNcIrL2014) #A unique long string that is not easy to guess
